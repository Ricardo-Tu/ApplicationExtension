...
*/
BOOLEAN CrackRE32::InitGameInformation(
...
)
{
    ...
    if (hProcessSnap == INVALID_HANDLE_VALUE)
    {
        ...
        g_dialog->GetDlgItem(IDC_EDIT2)->SetWindowTextW(szEditString.c_str());
...
*/
PVOID CrackRE32::GetModuleBaseAddress(
...
*/
STATUS CrackRE32::elevateprivileges()
{
    ...
    if (!status)
        return STATUS::ProcessOperationError;
...
*/
STATUS CrackRE32::ModifyLayerMemory32(
    _In_ PVOID lpBase,
    _In_ ULONG num,
    _In_ PULONG offset,
...
)
{
    ...
    if (!pTemp)
        return STATUS::ReadProcessMemoryError;
    ...
    if (!status)
        return STATUS::WriteProcessMemoryError;

    return STATUS::NoneError;
}
...
*/
STATUS CrackRE32::ReadLayerMemory32(
    _In_ PVOID lpBase,
...
*/
STATUS CrackRE32::AssemblyInject32(
...
*/
STATUS CrackRE32::RemoteThreadExecuteShellCode(
    BYTE* shellcode,
...
)
{
    ...
    if (!pRemoteThreadParam)
        return STATUS::AllocateRemoteVirtualMemoryError;
    ...
    if (hRemoteThread == INVALID_HANDLE_VALUE)
        return STATUS::CreateRetmoteThreadError;
